...
import 'csiclub_model.dart';
export 'csiclub_model.dart';

class CsiclubWidget extends StatefulWidget {
  const CsiclubWidget({Key? key}) : super(key: key);

  @override
  _CsiclubWidgetState createState() => _CsiclubWidgetState();
}

class _CsiclubWidgetState extends State<CsiclubWidget> {
  late CsiclubModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CsiclubModel());
  }
